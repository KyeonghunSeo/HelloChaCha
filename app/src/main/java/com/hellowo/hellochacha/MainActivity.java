...
public class MainActivity extends AppCompatActivity implements
    ...
    public ChaChaTurn mTurnData;

    private Button startBtn;
    private Button findMatchBtn;
    private Button selectPlayerBtn;
    TextView log;
    TextView turn;
    private ChaChaBoard board;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        board = new ChaChaBoard((FrameLayout)findViewById(R.id.rootView));
        int[] icons = new int[]{
                R.drawable.cha_0,
                R.drawable.cha_1,
                R.drawable.cha_2,
        ...
        selectPlayerBtn = (Button)findViewById(R.id.selectPlayerBtn);
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            } else if (resultCode == RC_LOOK_AT_MATCHES) {
    ...
    public void onQuickMatchClicked(View view) {
        ...
        ResultCallback<TurnBasedMultiplayer.InitiateMatchResult> cb =
                new ResultCallback<TurnBasedMultiplayer.InitiateMatchResult>() {
                    @Override
                    public void onResult(TurnBasedMultiplayer.InitiateMatchResult result) {
                        Log.d("aaa", "createMatch onResult");
    ...
    public void updateMatch(TurnBasedMatch match) {
        ...
        switch (turnStatus) {
            ...
            case TurnBasedMatch.MATCH_TURN_STATUS_THEIR_TURN:
                mTurnData = ChaChaTurn.unpersist(mMatch.getData());
                setGameplayUI();
                return;
    ...
    public void setViewVisibility() {
        ...
        log.setText(Games.Players.getCurrentPlayer(mGoogleApiClient).getDisplayName());
        //findViewById(R.id.login_layout).setVisibility(View.GONE);
    }

    // Switch to gameplay view.
    public void setGameplayUI() {
        log.setText(mTurnData.data);
        turn.setText("Turn " + mTurnData.turnCounter);
    ...
    public void startMatch(TurnBasedMatch match) {
        ...
        for (String id : mMatch.getParticipantIds()) {
            Participant player = mMatch.getParticipant(id);
            board.addPlayer(new ChaChaPlayer(player.getDisplayName(), player.getIconImageUri()));
        }

        Log.d("aaa", "playerId :" + playerId);
        Log.d("aaa", "myParticipantId :" + myParticipantId);
        ...
        Games.TurnBasedMultiplayer.takeTurn(mGoogleApiClient, match.getMatchId(),
                ...
                new ResultCallback<TurnBasedMultiplayer.UpdateMatchResult>() {
                    @Override
                    public void onResult(TurnBasedMultiplayer.UpdateMatchResult result) {
                        Log.d("aaa", "UpdateMatchResult onResult");
                        processResult(result);
                    }
                });
    }
    ...
    public void showErrorMessage(TurnBasedMatch match,
                                 int statusCode,
                                 int stringId) {
